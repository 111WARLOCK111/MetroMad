...
namespace MetroMad.Lua.gLua {
    ...
    public class saverestore {
        ...
        public virtual void AddRestoreHook(string identifier, function callback) {
        }
        ...
        public virtual void AddSaveHook(string identifier, function callback) {
        }
        ...
        public virtual void LoadEntity(Entity ent, IRestore save) {
        }
        
        // <realm>Shared</realm>
        // <summary>{{Internal}}</summary>
        // <param name="save">The restore object to read data from the save file with.</param>
        public virtual void LoadGlobal(IRestore save) {
        }
        ...
        // <return>table|The table that has been read, if any</return>
        public virtual table ReadTable(IRestore save) {
            return new table();
        }
        ...
        // <return>any|The variable that was read, if any.</return>
        public virtual any ReadVar(IRestore save) {
            return new any();
        }
        ...
        public virtual void SaveEntity(Entity ent, ISave save) {
        }
        
        // <realm>Shared</realm>
        // <summary>{{Internal}}</summary>
        // <param name="save">The save object to write data into the save file.</param>
        public virtual void SaveGlobal(ISave save) {
        }
        
        // <realm>Shared</realm>
        // <summary>Returns how many writable keys are in the given table.</summary>
        // <param name="table">The table to test.</param>
        // <return>number|The number of keys that can be written with {{LibraryFunction|saverestore|WriteTable}}.</return>
        public virtual int WritableKeysInTable(table table) {
            return 1;
        }
        ...
        public virtual void WriteTable(table table, ISave save) {
        }
        ...
        public virtual void WriteVar(any value, ISave save) {
        }
    }
}
