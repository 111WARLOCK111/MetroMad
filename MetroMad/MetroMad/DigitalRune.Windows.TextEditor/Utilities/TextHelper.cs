...
namespace DigitalRune.Windows.TextEditor
{
  ...
  public static class TextHelper
  {
    ...
    public static int FindClosingWord(IDocument document, int offset, string openBracket, string closingBracket)
    {
        return document.FormattingStrategy.SearchWordForward(document, offset, openBracket, closingBracket);
    }
    ...
    public static int FindStartOfIdentifier(IDocument document, int offset)
    {
      ...
      if (!Char.IsWhiteSpace(startCharacter))
        return offset;
      else
        return -1;
    }
