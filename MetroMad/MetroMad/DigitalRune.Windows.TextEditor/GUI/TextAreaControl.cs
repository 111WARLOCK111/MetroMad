...
namespace DigitalRune.Windows.TextEditor
{
  ...
  public class TextAreaControl : Panel
  {
    ...
    private MetroScrollBar _hScrollBar = new MetroScrollBar();
    ...
    public MetroScrollBar HScrollBar
    {
    ...
    public TextAreaControl(TextEditorControl motherTextEditorControl)
    {
      ...
      _vScrollBar.Scroll += VScrollBarValueChanged;
      _hScrollBar.Scroll += HScrollBarValueChanged;
      SetScrollBars();
    ...
    private void SetScrollBars()
    {
        if (_textArea.TextEditorProperties.ShowScrollBars)
        {
            ...
            _hScrollBar.UseBarColor = true;
            _vScrollBar.UseBarColor = true;

            _hScrollBar.HighlightOnWheel = true;
            _vScrollBar.HighlightOnWheel = true;

            _hScrollBar.Orientation = MetroScrollOrientation.Horizontal;
            _vScrollBar.Orientation = MetroScrollOrientation.Vertical;

            _hScrollBar.ScrollbarSize = 10;
            _vScrollBar.ScrollbarSize = 10;
    ...
    public void SetScrollBarBounds()
    {
        ...
        /*_vScrollBar.Bounds = new Rectangle(_textArea.Bounds.Right, 0, 10, Height - 10);
        _hScrollBar.Bounds = new Rectangle(0, _textArea.Bounds.Bottom, Width - 10, 10);*/

        _vScrollBar.Location = new Point(_textArea.Bounds.Right, 0);
        _hScrollBar.Location = new Point(0, _textArea.Bounds.Bottom);

        _vScrollBar.Size = new Size(10, Height - 20);
        _hScrollBar.Size = new Size(Width - 20, 10);
    }
