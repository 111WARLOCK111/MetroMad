...
namespace DigitalRune.Windows.TextEditor.Completion
{
  ...
  public abstract class AbstractCompletionWindow : Form
  {
    ...
    protected void ShowCompletionWindow()
    {
      ...
      TextEditorControl.ActiveTextAreaControl.VScrollBar.Scroll += ParentFormLocationChanged;
      TextEditorControl.ActiveTextAreaControl.HScrollBar.Scroll += ParentFormLocationChanged;
      TextEditorControl.ActiveTextAreaControl.VScrollBar.ScrollbarSize = 10;
      TextEditorControl.ActiveTextAreaControl.HScrollBar.ScrollbarSize = 10;
      TextEditorControl.ActiveTextAreaControl.VScrollBar.UseBarColor = true;
      TextEditorControl.ActiveTextAreaControl.HScrollBar.UseBarColor = true;
      TextEditorControl.ActiveTextAreaControl.VScrollBar.Orientation = MetroFramework.Controls.MetroScrollOrientation.Vertical;
      TextEditorControl.ActiveTextAreaControl.HScrollBar.Orientation = MetroFramework.Controls.MetroScrollOrientation.Horizontal;
      TextEditorControl.ActiveTextAreaControl.VScrollBar.HighlightOnWheel = true;
      TextEditorControl.ActiveTextAreaControl.HScrollBar.HighlightOnWheel = true;
