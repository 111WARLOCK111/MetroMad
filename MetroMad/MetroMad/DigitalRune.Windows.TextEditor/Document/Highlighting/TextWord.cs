...
namespace DigitalRune.Windows.TextEditor.Highlighting
{
  ...
  public class TextWord
  {
    ...
    public string Word
    {
      get
      {
          if (RowWord != null) return RowWord;
        if (_document == null)
          return String.Empty;
    ...
    public Color Color
    {
      get
      {
        ...
        set
        {
            /*if (_color != null)
                _color.Color = value;*/
            _color = new HighlightColor(value, true, true);
        }
    }
    ...
    public TextWord(IDocument document, LineSegment line, int offset, int length, HighlightColor color, bool hasDefaultColor, string row)
    {
        Debug.Assert(document != null);
        Debug.Assert(line != null);
        Debug.Assert(color != null);
