...
namespace DigitalRune.Windows.TextEditor.Formatting
{
    ...
    int SearchWordBackward(IDocument document, int offset, string openBracket, string closingBracket);
    ...
    int SearchWordForward(IDocument document, int offset, string openBracket, string closingBracket);
	}
}
