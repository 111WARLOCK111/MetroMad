...
namespace DigitalRune.Windows.TextEditor.Formatting
{
    ...
    public class DefaultFormattingStrategy : IFormattingStrategy
    {
        ...
        public virtual int SearchWordBackward(IDocument document, int offset, string openBracket, string closingBracket)
        {
            return -1;
        }
        ...
        public virtual int SearchWordForward(IDocument document, int offset, string openBracket, string closingBracket)
        {
            return -1;
        }
    }
